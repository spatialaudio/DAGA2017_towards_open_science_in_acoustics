...
Before introducing the open science approach in detail it is worthwhile to review the
...
focuses on the ease of access to scientific data underlying research and therefore supports the ease of reproducibility.
...
require to publish errata or revise the underlying data and code. Finally open 
